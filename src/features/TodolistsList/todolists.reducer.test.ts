...
test("correct todolist should be removed", () => {
  const endState = todolistsReducer(startState, todolistsThunk.removeTodolist.fulfilled({ id: todolistId1 }, "", ""));
...
test("correct todolist should be added", () => {
  ...
  const endState = todolistsReducer(
    startState,
    todolistsThunk.addTodolist.fulfilled({ todolist: todolist }, "requestId", "")
  );
